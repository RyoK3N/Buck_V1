...
DISCLAIMER = (
    "Buck's forecasts are generated by combining technical indicators, an "
    "LSTM, optional RL models, and an LLM's reasoning over that evidence. "
    "None of this is backtested or validated against held-out historical "
    "accuracy before being shown to you (see accuracy/ for live tracking of "
    "past predictions vs. actuals, which is the only accuracy signal this "
    "system has). This is NOT financial advice, and the confidence score is "
    "a measure of internal signal agreement, not of predictive accuracy. "
