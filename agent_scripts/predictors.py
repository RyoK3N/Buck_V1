...
class PredictorFactory:
    ...
    @staticmethod
    def create_claude_predictor(
        api_key: Optional[str] = None,
        model: Optional[str] = None,
        max_iterations: Optional[int] = None,
        thinking_budget: Optional[int] = None,
    ) -> IPredictor:
        """Create Claude (Anthropic) research-agent predictor."""
    ...
    @staticmethod
    def create_ensemble_with_claude(
        openai_api_key: str,
        ...
        """Ensemble of OpenAI + Claude predictors. Weights default to [1, 1]."""
        from .claude_predictor import ClaudePredictor
        return EnsemblePredictor(
            predictors=[
                OpenAIPredictor(openai_api_key, openai_model, 0.1, openai_base_url),
                ClaudePredictor(anthropic_api_key, model=claude_model),
            ],
            weights=weights,
        )
